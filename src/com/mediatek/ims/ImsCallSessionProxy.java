    ...
    */
    ...
    public void merge() {
        ...
        boolean needSwapConfToFg = (
                ...
                OperatorUtils.isMatched(OperatorUtils.OPID.OP136_Peru, mPhoneId) ||
    ...
    private class MyHandler extends Handler {
        ...
        private int imsReasonInfoCodeFromRilReasonCode(int causeCode) {
            ...
            switch (causeCode) {
                ...
                /* [VoLTE]Normal call failed, need to redial as ECC */
        ...
        private void updateOIR(String num, String pau) {
            ...
            if (TextUtils.isEmpty(num) && TextUtils.isEmpty(pau)) {
                ...
                oir = ImsCallProfile.OIR_PRESENTATION_RESTRICTED;
            } else if (!TextUtils.isEmpty(pau) &&
                    pau.toLowerCase().contains("unavailable") &&
                    OperatorUtils.isMatched(OperatorUtils.OPID.OP50, mPhoneId)) {
                oir = ImsCallProfile.OIR_PRESENTATION_UNKNOWN;
            } else if (!TextUtils.isEmpty(pau) &&
                    pau.toLowerCase().contains("interaction with other service") &&
                    OperatorUtils.isMatched(OperatorUtils.OPID.OP50, mPhoneId)) {
                oir = ImsCallProfile.OIR_PRESENTATION_UNKNOWN;
            }
    ...
    private boolean updateRat(int ratType, int callRat) {
        ...
        if (mCallRat != IMS_CALL_TYPE_UNKNOWN && mIsEmergencyCall) {
            return false;
        }
